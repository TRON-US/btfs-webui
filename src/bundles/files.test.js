...
it('write single file to root', async () => {
  ...
  expect(ipfs.files.cp.mock.calls[0][0]).toBe('/btfs/QmdfTbBqBPQ7VNxZEYEj14VmRuZBkqFbiwReogJgS1zR1n')
...
it('write multiple file', async () => {
  ...
  expect(ipfs.files.cp.mock.calls[1][0]).toBe('/btfs/QmdfTbBqBPQ7VNxZEYEj14VmRuZBkqFbiwReogJgS1zR1n')
