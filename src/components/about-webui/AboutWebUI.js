    ...
    <Box>
      ...
      <ul className='pl3'>
        ...
        <Trans i18nKey='welcomeInfo.paragraph2' t={t}>
          <li className='mb2'><a href='#/files' className='link blue u b'>View and manage files</a> in your BTFS repo, including drag-and-drop file import, easy pinning, and quick sharing and download options</li>
        </Trans>
        <Trans i18nKey='welcomeInfo.paragraph3' t={t}>
          <li className='mb2'><a href='#/explore' className='link blue b'>Visit the "Merkle Forest"</a> with some sample datasets and explore IPLD, the data model that underpins how BTFS works</li>
        </Trans>
