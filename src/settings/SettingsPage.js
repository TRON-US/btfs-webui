    ...
    <Box className='mb3 pa4'>
      <div className='charcoal'>
        ...
        <Trans i18nKey='cliDescription' t={t}>
          <p className='f6 mv2'>Enable this option to display a "view code" <StrokeCode className='dib v-mid icon mh1 fill-charcoal' viewBox='14 20 70 66' style={{ height: 24 }} /> icon next to common BTFS commands. Clicking it opens a modal with that command's CLI code, so you can paste it into the BTFS command-line interface in your terminal.</p>
        </Trans>
      </div>
    </Box>
